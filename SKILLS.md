...
> Step-by-step patterns for recurring development tasks, distilled from ~25 sessions of implementation. Each recipe lists the exact touch-points in the codebase and the order they must be done in. Read `CLAUDE.md` for the project overview and constraints. **Reflects Elysium v2.5.73 (client v2.5.73 / server v2.5.62).**

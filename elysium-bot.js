...
class Bot {
  ...
  _onChat(who, msg){
    ...
    if(/^help\b/i.test(bodyMatch) && (namedMe || this._isSpokesBot())){
      ...
      return this.chat(this.o.name + ' v' + BOT_VERSION + ' \u2014 I understand: "bleed N", "vote N", "block"/"no" (when I ask), "N"/"+N" (your intercept while you block me), "help".' + (several ? ' Aim at one bot with "@Name bleed N".' : ''));
    }
  }

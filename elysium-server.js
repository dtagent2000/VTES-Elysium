...
const HELPER_KEYS = ['on','unlockPrompt','counts','passConfirm','warn','edge','hand','handReminder','pathBlood','resBlock','resVote','resCombat','modeChoice'];   // srv-2.6.24 (R1 port): +modeChoice, the pre-commit Inferior/Superior chooser   // host-lockable helpers — mirror the client's HELPER_DEFS (v2.6.15: +the three Played-tab resolvers)
...
const REF_VERBS = new Set(['start','hostSetPool','hostOust','hostUnoust','setHelperPolicy','hostPass','hostSetClock','kick','demote','promote','mute','saveMatch','listSaves','delSave','loadMatch']);   // srv-2.6.35: the host-gated verbs a referee watcher may use
